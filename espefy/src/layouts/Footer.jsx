...
const Footer = () => {
  return (
    <footer className="bg-primary flex flex-wrap justify-between items-center py-4 md:py-12 px-4 md:px-12 lg:px-24 xl:px-36 border-t border-black">
      {/* Left Section */}
      <div className="w-full md:w-1/3 mb-8 md:mb-0 text-center md:text-left">
        ...
        <p className="font-black font-title leading-7 mb-4 text-lg uppercase text-white">Rejoignez-nous</p>
        <form className="flex">
          <div className="pr-2 w-3/4">
            <input
              type="email"
              className="border-white rounded-md border w-full py-3 px-6 focus:outline-none bg-transparent text-white"
              placeholder="Votre adresse e-mail"
              required
            />
          </div>
          <div className="w-1/4">
            <button className="w-full rounded-md border border-white  bg-black text-white text-xs block py-3 px-6 text-center" type="submit">
              Valider
            </button>
          </div>
        </form>
